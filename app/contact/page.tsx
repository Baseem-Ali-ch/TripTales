...
const FAQ_ITEMS = [
  ...
  {
    question: "Can I include links to my website or social media in my article?",
    answer:
      ...
      <main className="flex-1 pt-20">
        ...
        <section className="bg-muted/30 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Have a question, feedback, or want to contribute? We'd love to hear from you. Choose an option below to
              get started.
            </p>
          </div>
        </section>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            <Tabs defaultValue="contact" className="w-full" onValueChange={handleTabChange}>
              ...
              <TabsContent value="contact" className="mt-0">
                      ...
                      <form onSubmit={handleContactSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                            <Label htmlFor="name" className={errors.contact.name ? "text-destructive" : ""}>
                              Name
                            </Label>
                            <Input
                              id="name"
                            ...
                            />
                            {errors.contact.name && <p className="text-destructive text-sm">{errors.contact.name}</p>}
                          </div>

                          <div className="space-y-2">
                            <Label htmlFor="email" className={errors.contact.email ? "text-destructive" : ""}>
                              Email
                            </Label>
                            <Input
                              id="email"
                            ...
                            />
                            {errors.contact.email && <p className="text-destructive text-sm">{errors.contact.email}</p>}
                          </div>
                        </div>

                        <div className="space-y-2">
                          <Label htmlFor="subject" className={errors.contact.subject ? "text-destructive" : ""}>
                            Subject
                          </Label>
                          <Select
                          ...
                          >
                            <SelectTrigger id="subject" className={errors.contact.subject ? "border-destructive" : ""}>
                          ...
                          {errors.contact.subject && (
                            <p className="text-destructive text-sm">{errors.contact.subject}</p>
                          )}
                        </div>

                        <div className="space-y-2">
                          <Label htmlFor="message" className={errors.contact.message ? "text-destructive" : ""}>
                            Message
                          </Label>
                          <Textarea
                            id="message"
                            ...
                            onChange={handleContactInputChange}
                            className={cn("min-h-32", errors.contact.message ? "border-destructive" : "")}
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              ...
                              {contactForm.attachment ? "Change File" : "Attach File"}
                            </Button>
                            <input
                              ref={fileInputRef}
                              id="attachment"
                          ...
                          {contactForm.attachment && (
                            <div className="mt-2 flex items-center gap-2 text-sm">
                              ...
                              <span className="truncate">{contactForm.attachment.name}</span>
                              <Button
                                type="button"
                                variant="ghost"
                                size="icon"
                                className="h-6 w-6"
                                onClick={() => setContactForm({ ...contactForm, attachment: null })}
                              >
                                <X className="h-4 w-4" />
                              </Button>
                            </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              <a href="mailto:contact@blogfolio.com" className="hover:text-primary">
                ...
                <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Link href="/help" className="border rounded-lg p-6 bg-card hover:shadow-md transition-shadow">
                    ...
                    >
                      ...
                      <p className="text-muted-foreground">Learn about our content standards and submission process.</p>
                    </Link>
                    <Link href="/community" className="border rounded-lg p-6 bg-card hover:shadow-md transition-shadow">
                      <h3 className="font-bold mb-2">Community Forum</h3>
                      <p className="text-muted-foreground">
                        Connect with other writers and get help from the community.
                      </p>
                    </Link>
                  </div>
                </div>
                ...
                <div className="border rounded-lg p-6 bg-card">
                  ...
                  {currentStep === 1 && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="title" className={errors.blog.title ? "text-destructive" : ""}>
                          Blog Title
                        </Label>
                        <Input
                          id="title"
                          ...
                          className={errors.blog.title ? "border-destructive" : ""}
                          placeholder="Enter a compelling title for your blog"
                        />
                        {errors.blog.title && <p className="text-destructive text-sm">{errors.blog.title}</p>}
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="category" className={errors.blog.category ? "text-destructive" : ""}>
                          Category
                        </Label>
                        <Select
                        ...
                        >
                          <SelectTrigger id="category" className={errors.blog.category ? "border-destructive" : ""}>
                        ...
                        {errors.blog.category && <p className="text-destructive text-sm">{errors.blog.category}</p>}
                      </div>
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="blog-content" className={errors.blog.content ? "text-destructive" : ""}>
                          Content
                        </Label>
                        ...
                        {errors.blog.content && <p className="text-destructive text-sm">{errors.blog.content}</p>}
                        <p className="text-xs text-muted-foreground">
                          Write your blog content here. Use the toolbar to format your text.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="featured-image" className={errors.blog.featuredImage ? "text-destructive" : ""}>
                          Featured Image
                        </Label>
                        {blogForm.featuredImage ? (
                          <div className="relative aspect-video w-full rounded-md overflow-hidden border">
                            <Image
                              src={URL.createObjectURL(blogForm.featuredImage) || "/placeholder.svg"}
                              alt="Featured Image"
                              fill
                              className="object-cover"
                            />
                          ...
                          <div
                            className={cn(
                              ...
                              errors.blog.featuredImage ? "border-destructive" : "border-muted",
                            )}
                        ...
                        {errors.blog.featuredImage && (
                          <p className="text-destructive text-sm">{errors.blog.featuredImage}</p>
                        )}
                      </div>
                        ...
                        {showPreview ? (
                          <div className="border rounded-md p-6">
                            ...
                            <div className="prose prose-sm max-w-none dark:prose-invert">
                              ...
                              <div className="flex flex-wrap gap-2 mb-4">
                                <Badge>
                                  {BLOG_CATEGORIES.find((c) => c.toLowerCase() === blogForm.category) ||
                                    blogForm.category}
                                </Badge>
                                {selectedTags.map((tag) => (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="border rounded-md p-6">
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-muted-foreground">
                                    {blogForm.featuredImage ? "Featured image uploaded" : "No featured image"} •{" "}
                            ...
                            <div className="border rounded-md p-6 bg-muted/30">
                              <h3 className="font-bold mb-4">Submission Guidelines</h3>
                              <ul className="space-y-2 text-sm">
                                ...
                                <li className="flex items-start gap-2">
                                  <Check className="h-4 w-4 text-green-500 mt-0.5" />
                                  <span>
                                    By submitting, you confirm this is your original work and you have the rights to all
                                    content.
                                  </span>
                                </li>
                                <li className="flex items-start gap-2">
                  ...
                  {showConfirmDialog && (
                    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                      <div className="bg-card border rounded-lg p-6 max-w-md w-full">
                        ...
                        <p className="mb-6">
                          Are you sure you want to submit your blog? Once submitted, it will be reviewed by our
                          editorial team.
                        </p>
                  ...
                  {submitSuccess === true && (
                    <div className="mt-6 p-4 rounded-md bg-green-500/10 text-green-500 border border-green-500/20 flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-medium">Blog submitted successfully!</p>
                        <p className="text-sm">
                          Thank you for your submission. Our editorial team will review your blog and get back to you
                          soon.
                        </p>
                      </div>
                    </div>
