            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  At BlogFolio, we believe in the power of stories to inspire,
                  educate, and connect. Our mission is to create a platform
                  where thoughtful writers can share their insights and readers
                  can discover content that matters to them.
                </p>
                <p className="text-lg text-muted-foreground mb-8">
                  Founded in 2023, we've grown into a community of passionate
                  creators and curious minds. We curate content across
                  technology, design, productivity, lifestyle, and more.
                </p>
        ...
        <section className="py-16 bg-blue-100 dark:bg-[#000c29] dark:text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              ...
              resources, and insights delivered straight to your inbox.
            </p>
