      ...
      <div className="container flex items-center justify-between h-full">
        ...
        <Link href="/" className="flex items-center space-x-2">
          <motion.div
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-primary text-primary-foreground overflow-hidden"
          >
            <Image
              src="/logo2.png"
              alt="TripTales Logo"
          ...
          <span className="text-xl font-bold">TripTales</span>
        </Link>
